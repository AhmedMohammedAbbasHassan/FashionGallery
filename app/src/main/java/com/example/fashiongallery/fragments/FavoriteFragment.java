...
public class FavoriteFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
       ...
       rotateLoading = (RotateLoading)view.findViewById(R.id.loading_fav);
       recyclerView = (RecyclerView)view.findViewById(R.id.model_fav_recycler);
    ...
    void getFavModel()
    {
        ...
        call = clint.getMyFavorites( SharedPreferenceUtils.getUserId());
        ...
        call.enqueue(new Callback<ModelResponse>() {
            ...
            public void onResponse(Call<ModelResponse> call, Response<ModelResponse> response) {
                ...
                if (data.getCode().equals("200")){
                    ...
                    AppUtils.showLoading(false,rotateLoading,getActivity());
                    Toast.makeText(AppController.getContext(), "no favorites  model yet!.. ", Toast.LENGTH_SHORT).show();
